  ...
  S.listItem()
    ...
    .child(
      S.list()
        .title('Main Website Pages')
        .items([
          // S.listItem().title('Home').icon(HomeIcon).child(S.document().schemaType('page').documentId('')),
          S.divider(),
  ...
  S.listItem()
    ...
    .child(
      S.list()
        .title('Blog')
        .items([
          // S.listItem().title('Blog Homepage').icon(HomeIcon).child(S.document().schemaType('page').documentId('')),
